...
<head>
  ...
  <meta name"description" content"View Your Havit Nigeria Shopping Cart">
                    ...
                    ?>
                      <div class="row mb-4 d-flex justify-content-between align-items-center">
                        <div class="col-md-2 col-lg-2 col-xl-2">
                          <img alt="Havit Product Image" src="assets/img/products/<?php echo getName($connectDB, "product_image", "product_image", "product_id", $row['product_id']); ?>" class="img-fluid rounded-3" alt="<?php echo ucwords(getName($connectDB, "product_name", "tbl_products", "product_id", $row['product_id'])); ?>">
                        </div>
