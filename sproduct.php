...
<head>
  ...
  <meta property="og:site_name" content="Havit Ng">

  <!-- twitter card -->
 <meta name="twitter:card" content="summary_large_image" />
  <meta property="twitter:title" content="<?php echo ucwords($row['product_name']); ?>">
  <meta name="twitter:site" content="https://justhavit.com.ng" />
  <meta name="twitter:image:alt" content="HAVIT NG" />
  ...
  if (isImageSizeValid($imagePath, 1)) {
    ...
    echo '<meta property="og:image" content="https://justhavit.com.ng/' . $imagePath . '">';
    echo '<meta property="twitter:image" content="https://justhavit.com.ng/' . $imagePath . '">';
    echo '<meta property="msapplication-TileImage" content="https://justhavit.com.ng/' . $imagePath . '">';
   ...
   echo '<meta property="og:image" name"twitter:image:src" content="https://justhavit.com.ng/assets/img/havit.png">';
    echo '<meta property="twitter:image" content="https://justhavit.com.ng/assets/img/havit.png">';
  }
  ?>
...
<body class="body">
        ...
        <div id="wowslider-container1">
          <div class="ws_images">
            <ul>
              ...
              ?>
                  <li>
                    <img alt="Havit Product Image" src="assets/img/products/<?php
  ...
  $sentences = explode(".", $row['details']);
  // Output the description as an unordered list
  echo "<ul>";
  // Loop through each sentence and display them as list items
  foreach ($sentences as $sentence) {
    // Trim the sentence to remove extra spaces
    $sentence = trim($sentence);
    // Skip empty sentences
    if (!empty($sentence)) {
      // Display the sentence as a list item
      echo "<li>" . $sentence . ".</li>";
      // Add a styled horizontal rule after each sentence
      echo "<hr class='custom-hr'>";
    }
  }
    ...
    <div class="row mx-auto container-fluid">
      ...
      ?>
        <div class="product text-center col-lg-3 col-md-6 col-6">
          <img alt="Havit Product Image" onclick="window.location.href='sproduct?q=<?php echo $row['product_id']; ?>';" class="img-fluid mb-3" src="assets/img/products/<?php echo getName($connectDB, "product_image", "product_image", "product_id", $row['product_id']); ?>" alt="">
          <!--
                <div class="star">
...
-->
          ...
          <?php if (intval($row['stock']) > 0) { ?>
            <a href="assets/config/order_process?addCart=<?php echo $row['product_id'] ?>">
              <button class="buy-btn" <?php echo (intval($row['stock']) < 1) ? 'disabled' : "" ?>> Add to Cart </button>
            </a>
          <?php } ?>
        </div>
      <?php } ?>
