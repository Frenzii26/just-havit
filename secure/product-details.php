            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <div class="d-block lh-lg d-md-flex justify-content-between">
                        ...
                        <!-- Add Meta Data Modal Start -->
                <div>
                    <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#metaDataModal">
                        Update Meta Data
                    </button>
                    ...
                    <div class="modal fade" id="metaDataModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 style="color: rgb(22, 22, 22);" class="modal-title" id="exampleModalLabel">Update Meta Data</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <form action="" method="POST">
                                    <div class="modal-body">
                                      
                                    <label style="color: rgb(22, 22, 22);">Title Tag:</label>
                                    <input style="color: rgb(22, 22, 22);" type="text" id="title_tag" name="title_tag" class="form-control w-100 mb-3 rounded-0" value="<?php echo $titleTag; ?>">
                                    
                                    <label style="color: rgb(22, 22, 22);" for="meta_description">Meta Description:</label>
                                    <textarea id="meta_description" name="meta_description" class="form-control w-100" style="height: 150px;"><?php echo $metaDescription; ?></textarea>
                                    
                                    <div class="modal-footer">
                                        <button type="submit" name="updateMetadata" class="btn btn-primary">Update Metadata</button>
                                    </div>
